...
/system/bin/brcm_patchram_plus --patchram /etc/firmware/BCM4329.hcd /dev/ttyHS0
logi "Setting baudrate..."
/system/bin/brcm_patchram_plus -baudrate 3000000 --scopcm=0,2,0,0,0,0,0,0,0,0 /dev/ttyHS0 
